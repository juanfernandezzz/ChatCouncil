 ...
 *  · `build-judge-prompt` — **no tiene NINGÚN import, y es a propósito**: es
 *    la garantía estructural de que la identidad del proveedor no tiene por
 *    dónde entrar al prompt del evaluador. Verificado por gate en CI.
 *    Agregarle un import rompe la garantía, no sólo el estilo.
 */
export * from "./anonymize";
export * from "./build-judge-prompt";
